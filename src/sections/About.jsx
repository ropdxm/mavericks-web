  ...
  return (
    <Section id="fixed-target" className="about">
      ...
      <Left data-scroll data-scroll-sticky data-scroll-target="#fixed-target">
        We&apos;re robotics team from Shymkent. We are dedicated to win in FTC. We create unique engineering designs of robots
        that will blow your mind. We also make valuable contribution to the world of robotics.
